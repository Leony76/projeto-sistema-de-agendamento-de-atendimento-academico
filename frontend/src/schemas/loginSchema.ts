...
export const studentSchema = z.object({
  ...
  password: z.string().min(8, "A senha deve conter ao menos 8 caracteres").max(50, "O máximo de caractéres para a senha é de 50"),
});

export const managerSchema = z.object({
  email: z.email("E-mail inválido").max(50, "O e-mail não deve conter mais de 50 caracteres"),
  password: z.string().min(8, "Sua senha deve conter ao menos 8 caracteres").max(50, "O máximo de caractéres para a senha é de 50"),
});
